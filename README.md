...
* Python 3.5 and other basic packages
  * at 2017-06-14
  ...
  ```
* anaconda packages 
  * https://docs.continuum.io/anaconda/pkg-docs#python-3-5
  * at 2017-06-14
  
  ```
  _license:           1.1-py35_1        
  alabaster:          0.7.10-py35_0     
  anaconda:           4.4.0-np112py35_0 
  ...
  navigator-updater:  0.1.0-py35_0      
...
* manually installed conda packages
  * coverage
  * django 
  * markdown
  * psycopg2
  * cvxopt, cvxpy (from channel cvxgrp)
  
* manually installed pip packages
  * coreapi 
  * django-crispy-forms
  * django-filter
  * django-guardian
...
1. Execute `create_env2.bat` as administrator. (Remove Non-MKL NumPy)
1. Execute `create_env3.bat` as administrator. (Re-install MKL NumPy)
